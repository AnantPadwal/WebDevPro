...
for ($i=0; $i < 20; $i++) { 
    ...
    <div class="card card-body bg-primary text-light" style="height:700px; width:1100px; margin-left:133px; padding-top:25px; padding-bottom:25px;">
    ...
    <?php
    echo ('<span class="badge badge-warning">✒Author: @'.$response['articles'][$i]['author'].'</span><br>');
    ?>
