...
for ($i=0; $i < 20; $i++) { 
    ...
    <div class="card card-body bg-danger text-light" style="height:700px; width:1100px; margin-left:133px; padding-top:25px; padding-bottom:25px;">
    ...
    echo ('Press Name: <span class="badge badge-pill badge-warning">'.$response['articles'][$i]['source']['name'].'</span><br>');
